...
| Slot 0 | = „keine Slot-Angabe", nicht zwingend Simplex! Simplex-Repeater (RX=TX, z. B. DB0RUF 2 m) melden alle TGs mit `slot: 0`; es kommt aber auch auf Duplex-Relais vor (verifiziert 2026-07-13: DB0TU, statische TG 26231 mit slot 0). Anzeige unter TS1 — Beschriftung „1 (Simplex)" nur bei RX=TX, sonst „1 (BM: ohne Slot)". Codeplug: Slot 1; DMR MODE nach Gerät (0 nur bei RX=TX) — war dort schon immer korrekt |
