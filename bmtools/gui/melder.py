...
class GuiMelder:
    ...
    def __init__(self, sende: Callable[[Ereignis], None],
        ...
        # öffnen«, Dateien für »Bericht & Karte öffnen«, strukturierte
        # Ergebnisdaten (Karte/Kennzahlen/Relais) für
        # Bridge.lade_ergebnis (U4/U5)
        self.ergebnis_ordner: Path | None = None
        self.ergebnis_dateien: dict[str, Path] = {}
        self.lauf_daten: dict[str, Any] | None = None
