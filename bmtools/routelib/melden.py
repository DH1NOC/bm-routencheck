...
class Melder(Protocol):
    ...
    def ergebnis_daten(self, daten: dict[str, Any]) -> None:
        """Strukturierte Ergebnisdaten des Laufs (U4/U5): "karte"
        (mapview.karten_daten), "kennzahlen" (Distanz, Abdeckung) und
        "relais" (report.relais_daten). Die GUI baut daraus Karte,
        Top-Bar und DataGrid; das Terminal hat Tabelle und Dateien
        (No-op)."""
...
class TerminalMelder:
    ...
    def ergebnis_daten(self, daten: dict[str, Any]) -> None:
        pass  # Terminal: Tabelle, Panel und Dateien decken das ab
